...
\begin{align}
    \norm{T}_{L(X,Y)} \coloneqq \sup\limits_{u \in X \backslash \{ 0 \} }\dfrac{\norm{Tv}_Y}{\norm{v}_X}
\end{align}
とするとBanach空間になる．
...
\begin{align}
    \norm{f}_{X^{-1}}
    \coloneqq 
    \sup\limits_{u \in X \backslash \{ 0 \} }\dfrac{|f(v)|}{\norm{v}_X}
\end{align}
とするとBanach空間になる．
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                        %第三章%     %既存手法でのフィッツヒュー・南雲方程式の解に対する精度保証付き数値計算%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
